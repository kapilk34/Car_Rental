    ...
    <div className="px-4 py-10 md:px-10 flex-1">
      ...
      >
        ...
        <div className="flex items-center gap-2 w-full">
          <label htmlFor="car-image" className="cursor-pointer flex items-center gap-2">
            {image ? (
              <img
              ...
              <div className="h-14 w-14 flex items-center justify-center rounded bg-gray-100 border">
