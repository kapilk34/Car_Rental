...
const Banner = () => {
  return (
    <div className='relative flex flex-col md:flex-row items-center justify-between px-6 md:px-12 py-7 md:py-10 bg-gradient-to-r from-orange-500 to-orange-400 rounded-2xl overflow-hidden shadow-lg max-w-7xl mx-auto'>
      {/* Content */}
