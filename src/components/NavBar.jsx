...
const NavBar = () => {
  const { setShowLogin, user, logout, isOwner, cars, loginLoading } = useAppContext();
            ...
            <div className="hidden lg:flex items-center gap-4">
              ...
              {user ? (
                ...
                <button
                  ...
                  className={`px-6 py-2.5 rounded-xl text-white text-sm font-semibold bg-gradient-to-r from-accent to-accent-secondary transition-all duration-300 flex items-center justify-center gap-2 min-w-[100px] ${
                    loginLoading
                      ? "opacity-70 cursor-not-allowed"
                      : "hover:shadow-[0_8px_24px_rgba(var(--accent-rgb),0.35)] hover:-translate-y-0.5 active:translate-y-0"
                  }`}
                >
                  {loginLoading ? (
                    <>
            ...
            <button
              ...
              className={`w-full py-3.5 rounded-xl text-white font-semibold transition-all flex items-center justify-center gap-2 ${
                user 
                  ...
                  : loginLoading
                    ? "bg-gradient-to-r from-accent to-accent-secondary opacity-70 cursor-not-allowed"
